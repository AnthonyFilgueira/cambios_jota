            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form action="{{ route('currencies.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Ejemplo: PEN, USD, EUR</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Ejemplo: Sol Peruano, Dólar Estadounidense</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('symbol')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Ejemplo: S/., $, €, Bs.</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-gray-500">Ejemplo: 🇵🇪, 🇺🇸, 🇻🇪</p>
                    </div>
